    <div class="row">
        <div class="col s12 m10 offset-m1 little-padding white" id="profil">
            <div class="flex">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <img src="http://placehold.it/50x50" alt="Badge 3">
                        <img src="http://placehold.it/50x50" alt="Badge 4">
                    </div>
            ...
            <div class="col s10 m8 offset-m2 offset-s1">
                <h3>Notifications</h3>
                <form action="" method="POST" id="preferences">
                    <div class="switch">
                        <label>Suggestions d'annonces</label>
                        <label>
                          <input type="checkbox">
                ...
                <h3>Commentaires</h3>
                <!-- Single comment -->
                <div class="flex comment grey lighten-4">
                    <div>
...
>>>>>>> e577e32ab2eb25e26ba079eb19cee581d17b9acf:application/views/profil.php
